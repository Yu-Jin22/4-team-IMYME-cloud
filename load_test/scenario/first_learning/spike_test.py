"""
=============================================================================
MINE 부하 테스트 - 첫 학습 시나리오 (Spike Test)
=============================================================================
목적:
  - 시험기간이나 면접기간 때 많이 확 몰리는 환경에서의 트래픽 테스트
...
class SpikeTestUser(HttpUser):
    """Spike Test 사용자 - 급격한 트래픽 증가 시뮬레이션"""
    wait_time = between(1, 3)  # Spike 상황에서는 대기 시간을 짧게 설정
